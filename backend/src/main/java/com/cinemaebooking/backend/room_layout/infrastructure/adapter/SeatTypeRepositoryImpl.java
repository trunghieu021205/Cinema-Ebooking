...
import com.cinemaebooking.backend.room_layout.infrastructure.mapper.seatType.SeatTypeMapper;
import com.cinemaebooking.backend.room_layout.infrastructure.persistence.entity.SeatTypeJpaEntity;
import com.cinemaebooking.backend.room_layout.infrastructure.persistence.repository.SeatTypeJpaRepository;
...
public class SeatTypeRepositoryImpl implements SeatTypeRepository {
    ...
    @Override
    public Optional<BigDecimal> findBasePriceById(SeatTypeId seatTypeId) {
        return jpaRepository.findBasePriceById(seatTypeId.getValue());
    }
