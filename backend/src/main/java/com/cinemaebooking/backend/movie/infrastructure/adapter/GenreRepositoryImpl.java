...
import com.cinemaebooking.backend.movie.infrastructure.mapper.GenreMapper;
...
public class GenreRepositoryImpl implements GenreRepository {
    ...
    public Genre create(Genre genre) {
        ...
        GenreJpaEntity saved = jpaRepository.save(entity);
    ...
    @Override
    public Set<Genre> findAllByIdIn(Set<GenreId> ids) {
