...
public class RevokeUserCouponValidator {

    private final UserCouponRepository userCouponRepository;

    public void validate(RevokeUserCouponRequest request) {
        if (request == null) {
            throw CommonExceptions.invalidInput("Revoke request must not be null");
        }
